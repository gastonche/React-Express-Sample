  ...
  return (
    <form onSubmit={submit}>
      <DialogWrapper onClose={props.cancel}
        ...
        footer={
          <span>
            <button className="button large dark main full" data-icon="lock">Sign In</button>
            <div>
                Don't have an account? <span className="link" onClick={() => props.hide({register: true})}>Sign Up</span>
            </div>
          </span>
        }
      />
